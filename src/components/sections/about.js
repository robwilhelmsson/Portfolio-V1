...
const About = () => {
  return (
    <StyledAboutContainer>
      ...
      <p>Through a career of ski coaching, I have built an expert problem solving mindset that I have been able to use in an array of different situations and challenges. Having loved everything to do with computers, and technology at a young age, I would now like to use these skills to pursue a path in software engineering. </p>
